/* <div class="row justify-content-center">
  ...
  const criarCard = async (personaImagem, personaNome, personaEspecie, personaStatus, personaLocalizacao, personaEpisodio) => {
    
    const personaCard = document.createElement('div')
    personaCard.className = 'col-12 col-md-4 d-flex justify-content-center align-self-center mt-5 mb-5'; // Dimensões do card
  
    const estiloCard = document.createElement('div')
    estiloCard.className = 'card border-2 border-success' // Borda e cor
  ...
  const setaPersonagens = async (personagens) => {
    ...
    // Limitar a exibição aos primeiros 9 personagens (3 linhas de 3 cards cada)
